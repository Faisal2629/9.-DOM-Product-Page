// const products = [...];  // your product array here
...
//     const sortType = sortRating.value;
//     let sortedProducts = [...products];
...
function sortByPrice(productsArray, order) {
    return productsArray.sort((a, b) => {
        return order === 'price-low-to-high' ? a.price - b.price : b.price - a.price;
    });
}

// Function to sort products by popularity
function sortByPopularity(productsArray, order) {
    return productsArray.sort((a, b) => {
        return order === 'popularity-low-to-high' ? a.rating.rate - b.rating.rate : b.rating.rate - a.rating.rate;
    });
}

// Event Listeners
document.getElementById('filterByCategory').addEventListener('change', (e) => {
    const filteredProducts = filterByCategory(e.target.value);
    renderProducts(filteredProducts);
});

document.getElementById('sortByPrice').addEventListener('change', (e) => {
    const sortedProducts = sortByPrice(filteredProducts || products, e.target.value);
    renderProducts(sortedProducts);
});

document.getElementById('sortByPopularity').addEventListener('change', (e) => {
    const sortedProducts = sortByPopularity(filteredProducts || products, e.target.value);
    renderProducts(sortedProducts);
});
